...
p_id_proveedor int not null,
p_id_producto int not null,
primary key(p_id_proveedor,p_id_producto),
constraint proveedores_productos_productos_fk foreign key (p_id_producto) references productos(id_producto),
constraint proveedores_productos_proveedores_fk foreign key (p_id_proveedor) references proveedores(id_proveedor)
);
